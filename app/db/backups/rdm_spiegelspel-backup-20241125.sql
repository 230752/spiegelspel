...
--
-- Host: localhost:3306
-- Generation Time: Nov 25, 2024 at 03:54 PM
...
INSERT INTO `admin_users` (`au_id`, `au_username`, `au_login-email`, `au_password`, `au_permissions`, `au_creation-date`, `au_last-modified`, `au_deleted-date`) VALUES
(1, 'admin', 'admin@admin.com', '$2y$10$fyZHpqjYBiOimoHwXG4tRuIOl0PYRz6UqBDhPrlIYOWzMzX0Sypli', 1, '2024-11-25 12:29:30', '2024-11-25 12:30:22', NULL);
...
INSERT INTO `admin_user_permissions` (`aup_id`, `aup_name`, `aup_admin-users`, `aup_images`, `aup_site-data`, `aup_contact`, `aup_creation-date`, `aup_last-modified`, `aup_deleted-date`) VALUES
(1, 'administrator', 1, 1, 1, 1, '2024-11-25 12:29:24', '2024-11-25 12:29:24', NULL);
...
--
ALTER TABLE `admin_users`
  MODIFY `au_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `admin_user_permissions`
--
ALTER TABLE `admin_user_permissions`
  MODIFY `aup_id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
